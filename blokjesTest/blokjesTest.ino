...
MI0283QT9 lcd;
//getallen:
uint16_t obstakelLocatie1, jumpLoopCount, score, i, last_x, x, topscore, obstakelBovenkant = 128, spelerRechterZijde = 53, current = 139;
uint8_t up = 70;
...
uint8_t zbutton, in_air, obstakelActief1, toJump, gameStart, buttonPressed, gameIsLive, death, postGame,charverandering, scoresBack, bovenBlok = 0, jumpPause = 0;
...
//  if(spelerRechterZijde > obstakelLocatie1){
//    if(current+20 > obstakelBovenkant && !bovenBlok){
//      death++;
//    }else if(current+19 == obstakelBovenkant){
//      jumpPause++;
//    }
//  }
//  if(current+20 == obstakelBovenkant){
//    bovenBlok++;
//  }
//  if(current+20 > obstakelBovenkant && spelerRechterZijde > obstakelLocatie1){
//    bovenBlok = 0;
//  }
//  if(bovenBlok && 12 > obstakelLocatie1){
//    jumpPause++;
//  }
//  if(32 < (obstakelLocatie1)){
//    jumpPause = 0;
//  }
//  && current+20 > obstakelBovenkant && 32 < (obstakelLocatie1 + 32)){
